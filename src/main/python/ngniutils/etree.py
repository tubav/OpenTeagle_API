...
try:
	...
	logger.warning("lxml library not found, trying builtin ElementTree implementations. Pretty printing will be disabled.")
	try:
...
sys.modules[__name__ + ".impl"] = ElementTree = impl
